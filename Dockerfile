...
# Define dependencies.
ENV lib_deps="make g++-8 gcc-8 git zlib1g-dev libncurses5-dev build-essential libssl-dev libpcre2-dev zip vim libncurses5"
ENV build_deps="wget xz-utils cmake python git gdb tcl python3"
